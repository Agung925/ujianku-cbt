<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-2xl font-bold text-base-content">Buat Ujian Baru</h1>
        </div>
    </x-slot>

    <div class="card bg-base-100 shadow max-w-3xl">
        <div class="card-body">
            <form action="{{ route('guru.ujian.store') }}" method="POST" class="space-y-4">
                @csrf
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <a href="{{ route('guru.ujian.index') }}" class="btn btn-ghost">Batal</a>
                </div>
            </form>
        </div>
    </div>
