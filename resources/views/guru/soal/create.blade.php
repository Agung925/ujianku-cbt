<x-app-layout>
    <x-slot name="header">
        <h1 class="text-2xl font-bold text-base-content">Buat Soal Baru</h1>
    </x-slot>
    ...
    <div class="card bg-base-100 shadow max-w-4xl">
        <div class="card-body">
            <form action="{{ route('guru.soal.store') }}" method="POST" class="space-y-4">
                ...
                <div class="form-control">
                    ...
                    >
                        ...
                        @foreach ($kategoriUjians as $kategori)
                            <option value="{{ $kategori->id }}" @selected(old('kategori_ujian_id') == $kategori->id || request('kategori_ujian_id') == $kategori->id)>
                                {{ $kategori->nama }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <div class="space-y-2">
                        <label class="label cursor-pointer">
                            ...
                            <input 
                                ...
                                @checked(old('tipe_soal') === 'pilihan_ganda' || !old('tipe_soal'))
                ...
                <div id="pg-container" class="space-y-4" @if(old('tipe_soal') === 'essay') style="display: none;" @endif>
                    ...
                    <div class="form-control">
                        ...
                        >
                            ...
                            @foreach(['a' => 'A', 'b' => 'B', 'c' => 'C', 'd' => 'D'] as $value => $label)
                                <option value="{{ $value }}" @selected(old('kunci_jawaban') === $value)>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div id="essay-container" @if(old('tipe_soal') !== 'essay') style="display: none;" @endif>
                    <div class="form-control">
                        <label class="label">
                        ...
                        >{{ old('tipe_soal') === 'essay' ? old('kunci_jawaban') : '' }}</textarea>
                        @error('kunci_jawaban')
                            <label class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </label>
